    ...
    <section ref={sectionRef} className="py-20 md:py-32 lg:py-40 px-6 md:px-10">
      <div className="max-w-[1400px] mx-auto">
        <div data-title className="text-center mb-16 md:mb-24">
          <span className="text-eyebrow text-esmeralda block mb-4">Seleccion exclusiva</span>
          <h2 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl">Piezas destacadas</h2>
        </div>
